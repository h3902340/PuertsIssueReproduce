...
{
    public static class PuertsTest_JsBehaviour_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new PuertsTest.JsBehaviour();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(PuertsTest.JsBehaviour), result);
                    }
                }
        ...
        private static void G_jsEnv(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = PuertsTest.JsBehaviour.jsEnv;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"jsEnv", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_jsEnv, Setter = S_jsEnv} },
